...
# MTK 26.0 platform public policy
26.0_PLAT_PUBLIC_POLICY += $(BOARD_PREBUILTS_BASIC_PUBLIC_PLAT_DIRS)
# MTK 26.0 platform private policy
26.0_PLAT_PRIVATE_POLICY += $(BOARD_PREBUILTS_BASIC_PRIVATE_PLAT_DIRS)
endif
ifeq ($(strip $(MTK_BSP_PACKAGE)), yes)
# MTK 26.0 platform public policy
26.0_PLAT_PUBLIC_POLICY += $(BOARD_PREBUILTS_BSP_PUBLIC_PLAT_DIRS)
# MTK 26.0 platform private policy
26.0_PLAT_PRIVATE_POLICY += $(BOARD_PREBUILTS_BSP_PRIVATE_PLAT_DIRS)
endif
ifneq ($(strip $(MTK_BASIC_PACKAGE)), yes)
ifneq ($(strip $(MTK_BSP_PACKAGE)), yes)
# MTK 26.0 platform public policy
26.0_PLAT_PUBLIC_POLICY += $(BOARD_PREBUILTS_FULL_PUBLIC_PLAT_DIRS)
# MTK 26.0 platform private policy
26.0_PLAT_PRIVATE_POLICY += $(BOARD_PREBUILTS_FULL_PRIVATE_PLAT_DIRS)
endif
endif
...
#26.0.cil, 26.0.ignore.cil and nonplat_sepolicy.cil must be replaced with mtk 26.0
#release edition, so the original google edition is commented out
...
26.0_mapping.cil := $(BOARD_COMPAT_MAPPING_CIL_DIRS)
26.0_mapping.ignore.cil := $(BOARD_COMPAT_MAPPING_IGNORE_CIL_DIRS)
26.0_nonplat := $(BOARD_26.0_NONPLAT_FILE)
...
# MTK: If board platform policy is excluded, domain.te modified by MTK with aee_aedv
# will have build error. So limitation is removed here.
